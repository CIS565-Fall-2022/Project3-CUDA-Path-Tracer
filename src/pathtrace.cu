...
static GPUArray<glm::vec3>             dev_image;
static GPUArray<Geom>                  dev_geoms;
static GPUArray<Material>              dev_materials;
static GPUArray<PathSegment>           dev_paths;
static GPUArray<ShadeableIntersection> dev_intersections;

// TODO: static variables for device memory, any extra info you need, etc
// ...
static PathSegPool hst_path_pool;
...
void pathtrace(uchar4 *pbo, int frame, int iter) {
  ...
  shadeFakeMaterial KERN_PARAM(numblocksPathSegmentTracing, blockSize1d) (
    iter,
    num_paths,
    dev_intersections,
    dev_paths,
  ...
  dim3 numBlocksPixels = (pixelcount + blockSize1d - 1) / blockSize1d;
    finalGather KERN_PARAM(numBlocksPixels, blockSize1d) (num_paths, dev_image, dev_paths);

    ///////////////////////////////////////////////////////////////////////////

    // Send results to OpenGL buffer for rendering
    sendImageToPBO KERN_PARAM(blocksPerGrid2d, blockSize2d) (pbo, cam.resolution, iter, dev_image);
